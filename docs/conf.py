...
latex_documents = [
    ("index", "Kademlia.tex", "Kademlia Documentation", "Brian Muller", "manual"),
]
...
man_pages = [("index", "kademlia", "Kademlia Documentation", ["Brian Muller"], 1)]
